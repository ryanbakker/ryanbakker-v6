    ...
    <section className="section-parent py-16">
      <div className="section-child">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* GitHub Card */}
          <div className="relative w-full h-[300px] group overflow-hidden rounded-[30px]">
          ...
          <div className="relative md:col-span-3 w-full h-[220px] group overflow-hidden rounded-[30px]">
            <GlassyGreen className="absolute inset-0 w-full h-full z-0" />
            <div className="flex flex-row items-center justify-between">
              <div className="relative z-10 m-8 p-5 h-full bg-[#161917] border border-[#1BA04A] rounded-xl">
                ...
                <div className="flex flex-row w-full h-full items-center">
                  ...
                  <div>
                    ...
                    <Link href="/song-link" className="ml-auto">
