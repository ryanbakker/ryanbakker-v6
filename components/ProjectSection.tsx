...
function ProjectSection() {
  return (
    <section className="section-parent py-16 pb-64 md:pb-16 min-h-screen bg-[#EBEBEB]">
      <div className="section-child w-full h-full max-w-7xl lg:max-w-none lg:px-0 mx-auto text-neutral-950">
        ...
        <div className="flex flex-row h-[70vh] w-full mt-4">
          ...
          <ul className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_140px] gap-4 lg:gap-0 h-full w-full">
